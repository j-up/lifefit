  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "2026년 기준 단축 후 최초 12개월은 통상임금 상한액(250만 원)의 100%를 기준으로 표르는 급여를 지원하고, 이후에는 80%를 기준으로 지원합니다. 회사 지급액과 합하면 원래 월급의 80~90% 수준을 유지할 수 있습니다.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "육아기 근로시간 단축은 자녀 1명당 최대 3년까지 사용할 수 있습니다. 양쉱돌이 모두 사용 가능하나, 동일 자녀에 대해서는 동시에 사용할 수 없고 순차적으로만 이용 가능합니다.",
        },
      },
      {
        "@type": "Question",
